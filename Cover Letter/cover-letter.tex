...
\newkomavar{subtitle}\setkomavar{subtitle}{Final-year Computer Science Student} % Set the subtitle line for the first page header, leave empty for no subtitle
