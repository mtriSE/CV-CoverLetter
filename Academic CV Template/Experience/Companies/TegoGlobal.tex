\resumeSubheading
    ...
    \item \justifying{Facilitated seamless integration of the Slack bot API with existing systems, achieving a big reduction in notification latency, ensuring timely delivery of notifications.
